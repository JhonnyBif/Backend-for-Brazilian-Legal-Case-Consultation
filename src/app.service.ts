...
export class AppService {
  ...
  async getProcesso(n_processo: string) {
    ...
    if (
      !this.tribunais[processo.j] ||
      !this.tribunais[processo.j][processo.tr - 1] ||
      !this.tribunais[processo.j][processo.tr - 1].link
    ) {
  ...
  validaNumero(n_processo: string) {
    ...
    const bcmod = (x, y) => {
      ...
      do {
        const a = parseInt(mod + x.substr(0, take));
        x = x.substr(take);
        mod = a % y;
      } while (x.length);
    ...
    const digitoVerificadorCalculado =
      98 -
      bcmod(numeroSequencial + anoInicio + ramo + tribunal + vara + '00', '97');
    ...
    try {
      ...
      if (!response.data.hits.hits[0]) {
        return console.error(
          'Erro! Não foi possível encontrar dados do processo. Isso pode acontecer porque ele é sigiloso ou não há movimentações ou está tramitando em outro tribunal.',
        );
      }
  ...
  tribunais = {
    ...
    6: [
      ...
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-ac/_search',
        nome: 'Tribunal Regional Eleitoral do Acre',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-al/_search',
        nome: 'Tribunal Regional Eleitoral de Alagoas',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-ap/_search',
        nome: 'Tribunal Regional Eleitoral do Amapá',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-am/_search',
        nome: 'Tribunal Regional Eleitoral de Amazonas',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-ba/_search',
        nome: 'Tribunal Regional Eleitoral da Bahia',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-ce/_search',
        nme: 'Tribunal Regional Eleitoral do Ceara',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-dft/_search',
        nome: 'Tribunal Regional Eleitoral do Distrito Federal',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-es/_search',
        nome: 'Tribunal Regional Eleitoral do Espirito Santo',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-go/_search',
        nome: 'Tribunal Regional Eleitoral de Goias',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-ma/_search',
        nome: 'Tribunal Regional Eleitoral do Maranhão',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-mt/_search',
        nome: 'Tribunal Regional Eleitoral do Mato Grosso',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-ms/_search',
        nome: 'Tribunal Regional Eleitoral do Mato Grosso do Sul',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-mg/_search',
        nome: 'Tribunal Regional Eleitoral de Minas Gerais',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-pa/_search',
        nome: 'Tribunal Regional Eleitoral do Pará',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-pb/_search',
        nome: 'Tribunal Regional Eleitoral da Paraíba',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-pr/_search',
        nome: 'Tribunal Regional Eleitoral do Paraná',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-pe/_search',
        nome: 'Tribunal Regional Eleitoral de Pernambuco',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-pi/_search',
        nome: 'Tribunal Regional Eleitoral do Piaui',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-rj/_search',
        nome: 'Tribunal Regional Eleitoral do Rio de Janeiro',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-rn/_search',
        nome: 'Tribunal Regional Eleitoral do Rio Grande do Norte',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-rs/_search',
        nome: 'Tribunal Regional Eleitoral do Rio Grande do Sul',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-ro/_search',
        nome: 'Tribunal Regional Eleitoral de Rondonia',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-rr/_search',
        nome: 'Tribunal Regional Eleitoral de Roraima',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-sc/_search',
        nome: 'Tribunal Regional Eleitoral de Santa Catarina',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-se/_search',
        nome: 'Tribunal Regional Eleitoral de Sergipe',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-sp/_search',
        nome: 'Tribunal Regional Eleitoral de São Paulo',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tre-to/_search',
    ...
    8: [
      ...
      },
      {
        ...
        nome: 'Tribunal de Justiça do Estado do Amapá',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tjam/_search',
        nome: 'Tribunal de Justiça do Estado de Amazonas',
      },
      {
      ...
      },
      {
        ...
        nome: 'Tribunal de Justiça do Estado do Mato Grosso',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tjms/_search',
        nome: 'Tribunal de Justiça do Estado do Mato Grosso do Sul',
      },
      {
      ...
      },
      {
        ...
        nome: 'Tribunal de Justiça do Estado do Pará',
      },
      {
      ...
      },
      {
        ...
        nome: 'Tribunal de Justiça do Estado de Pernambuco',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tjpi/_search',
        nome: 'Tribunal de Justiça do Estado do Piaui',
      },
      {
      ...
      },
      {
        ...
        nome: 'Tribunal de Justiça do Estado do Rio Grande do Sul',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tjrn/_search',
        nome: 'Tribunal de Justiça do Estado do Rio Grande do Norte',
      },
      {
        link: 'https://api-publica.datajud.cnj.jus.br/api_publica_tjro/_search',
        nome: 'Tribunal de Justiça do Estado de Rondonia',
      },
      {
